...
This Privacy Policy explains how Basic Tracker ("we", "our", or "the app") collects, uses, and protects information when you use our mobile application. We are committed to protecting your privacy and being transparent about our data practices.

## Developer Information

**App Name:** Basic Tracker  
...
- **Tracking Items:** Names, sentiment indicators (positive/negative/neutral), and archived status
- **Tracking Entries:** Records of when items were marked as completed on specific dates
- **Notes:** Text notes associated with tracking items and specific dates
- **App Preferences:** Settings such as default item view and last selected date
- **Item Order:** Custom ordering of items in the drawer menu
...
- **Advertisements:** Device and usage information may be collected by third-party ad networks. Tracking item content and notes will **never** be shared.
...
- Tracking item content, names, or notes on external servers
...
- Tracking items, entries, notes, and app data remain **local to your device**.
- No tracking content is shared or used for advertising or analytics unless you explicitly opt-in to future features.

---

## Data Security

- **Local Storage:** All tracking data is stored securely in a local SQLite database.
...
- Users can delete individual tracking items, entries, or notes at any time.
- Users can archive items to hide them without deleting historical data.
...
- Access, modify, delete, and manage tracking items and data at any time.
- Archive and unarchive items as needed.
...
- You can delete individual tracking items, entries, or notes within the app
...
By using Basic Tracker, you consent to this Privacy Policy. If you do not agree, please do not use the app.

---

**Summary:**
- ✓ Tracking data stored locally only
- ✓ No tracking content shared
- ✓ Currently no ads or analytics
- ✓ Optional future features require user consent
- ✓ Users have full control over their data
- ✓ Archive feature preserves data without deletion
